...
class DBN(object):
    ...
    def __init__(self, numpy_rng, theano_rng=None, n_ins=784,
                 hidden_layers_sizes=[500, 500], n_outs=10,W=None):
...
if __name__ == '__main__':
    ...
    train_prob,test_prob,valid_prob,rbm_layers=test_DBN(finetune_lr=0.1, pretraining_epochs=10,pretrain_lr=0.01, k=1, training_epochs=10,
            train_set_x=train_set_x, train_set_y=train_set_y,
            valid_set_x=valid_set_x, valid_set_y=valid_set_y,
            test_set_x=test_set_x, test_set_y=test_set_y,
